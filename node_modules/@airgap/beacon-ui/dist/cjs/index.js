...
const _tmpl$$8 = /*#__PURE__*/web.template(`<div class="loader"></div>`, 2);
const Loader = _ => {
  return _tmpl$$8.cloneNode(true);
};

const _tmpl$$7 = /*#__PURE__*/web.template(`<div><div><div class="alert-header"><div class="alert-logo"></div><div class="alert-button-icon"></div></div><div class="alert-modal-loading-wrapper"></div><div class="alert-body"></div></div></div>`, 14),
  _tmpl$2$6 = /*#__PURE__*/web.template(`<div class="alert-button-icon"></div>`, 2),
  _tmpl$3$5 = /*#__PURE__*/web.template(`<div class="alert-button-icon-empty"></div>`, 2),
...
const Alert = props => {
  ...
  return (() => {
    ...
    web.insert(_el$3, (() => {
      ...
      return () => _c$() && (() => {
        const _el$8 = _tmpl$2$6.cloneNode(true);
    ...
    web.insert(_el$3, (() => {
      ...
      return () => _c$2() && _tmpl$3$5.cloneNode(true);
    })(), _el$4);
    ...
    web.insert(_el$, (() => {
      ...
      return () => _c$() && (() => {
        ...
        web.insert(_el$3, (() => {
          ...
          return () => _c$3() && (() => {
            const _el$7 = _tmpl$3$4.cloneNode(true);
...
var styles$5 = ".top-wallets-wrapper {\n  margin-bottom: 1.8em;\n}\n\n.top-wallets-info {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n}\n\n.theme__dark .top-wallets-info h3 {\n  color: white;\n}\n\n.theme__dark .top-wallets-info span {\n  color: #b5b8be;\n}\n\n.theme__dark .top-wallets-other-wallets-left h3 {\n  color: white;\n}\n\n.top-wallets-info h3 {\n  text-align: center;\n  color: #334155;\n  margin: 0px;\n  font-size: 0.938rem;\n}\n\n.top-wallets-info span {\n  text-align: center;\n  max-width: 300px;\n  font-size: 0.8em;\n  font-weight: 300;\n  color: #7c828b;\n  line-height: 1.35em;\n  margin: 6px 0px 12px 0px;\n}\n\n.top-wallets-learn-more {\n  text-decoration: underline;\n  cursor: pointer;\n  font-size: 0.95em !important;\n}\n\n.top-wallets-wallets-main {\n  margin-top: 1em;\n  grid-template-columns: repeat(2, 1fr);\n  display: grid;\n  gap: 1em;\n}\n\n.top-wallets-other-wallets {\n  display: flex;\n  gap: 1.25em;\n  justify-content: space-between;\n  border-radius: 12px;\n  padding: 1.25em;\n  cursor: pointer;\n  transition: all ease 0.2s;\n\n  -webkit-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  -moz-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n}\n\n.top-wallets-other-wallets-left {\n  max-width: 148px;\n}\n\n.top-wallets-other-wallets-left h3 {\n  color: #334155;\n  margin: 0px;\n  font-size: 1em;\n}\n\n.top-wallets-other-wallets-left p {\n  max-width: 400px;\n  font-size: 0.85em;\n  font-weight: 300;\n  color: #94a3b8;\n  line-height: 1.35em;\n  margin: 0px;\n  font-size: 0.75em;\n}\n\n.top-wallets-other-wallets-right {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.top-wallets-other-wallets-right img {\n  border-radius: 8px;\n  width: 2.4em;\n  height: 2.4em;\n  -webkit-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  -moz-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n}\n\n.top-wallets-other-wallets-center-wallet {\n  transform: perspective(500px) translateZ(100px);\n}\n\n@media only screen and (max-width: 800px) {\n  .top-wallets-info h3 {\n    font-size: 1em;\n  }\n\n  .top-wallets-info p {\n    font-size: 0.75em;\n  }\n\n  .top-wallets-other-wallets {\n    flex-direction: column;\n    text-align: center;\n    justify-content: center;\n    align-items: center;\n  }\n\n  .top-wallets-other-wallets-left {\n    order: 1;\n  }\n\n  .top-wallets-other-wallets-left h3 {\n    font-size: 0.85em;\n  }\n\n  .top-wallets-other-wallets-left p {\n    font-size: 0.65em;\n  }\n}\n\n@media only screen and (max-width: 400px) {\n  .top-wallets-other-wallets-right {\n    max-width: 50px;\n    transform: scale(0.8);\n  }\n}\n";

const _tmpl$$5 = /*#__PURE__*/web.template(`<div class="top-wallets-wrapper"><div class="top-wallets-info"><h3>Connect Wallet</h3><span>If you don't have a wallet, you can select a provider and create one now. <span class="top-wallets-learn-more">Learn more</span></span></div><div class="top-wallets-wallets-main"></div></div>`, 12),
  _tmpl$2$4 = /*#__PURE__*/web.template(`<div class="top-wallets-other-wallets"><div class="top-wallets-other-wallets-left"><h3>Other Wallets</h3><p>See other wallets you can use to connect</p></div><div class="top-wallets-other-wallets-right"><img><img class="top-wallets-other-wallets-center-wallet"><img></div></div>`, 13);
const TopWallets = props => {
  ...
  return (() => {
    ...
    web.insert(_el$8, (() => {
      ...
      return () => _c$() && (() => {
        const _el$9 = _tmpl$2$4.cloneNode(true),
...
var styles$4 = ".wallets-button {\n  border-radius: 6px;\n  background-color: transparent;\n  border: 1px solid #3880ff;\n  color: #3880ff;\n  width: 100%;\n  padding: 12px 0px;\n  margin-bottom: 1.8em;\n  transition: all ease 0.2s;\n  cursor: pointer;\n  font-size: 0.9em;\n}\n\n.wallets-button:hover {\n  color: white;\n  background-color: #3880ff;\n}\n\n.wallets-list-main-wrapper {\n  position: relative;\n}\n\n.wallets-list-wrapper {\n  display: grid;\n  overflow-y: auto;\n  grid-template-columns: repeat(4, 1fr);\n  padding: 1.8em 0px;\n  gap: 1.2em 0em;\n  max-height: 180px;\n}\n\n@media only screen and (max-width: 800px) {\n  .wallets-list-wrapper {\n    display: flex;\n    flex-direction: column;\n    gap: 12px;\n    max-height: 300px;\n    padding: 1.6em 0.6em;\n    margin-top: 0px;\n  }\n\n  .wallets-list-main-wrapper::before {\n    position: absolute;\n    top: 0px;\n    content: '';\n    left: -24px;\n    width: calc(100% + 48px);\n    background: radial-gradient(\n      circle,\n      rgba(171, 171, 171, 0.7329525560224089) 0%,\n      rgba(193, 193, 193, 0.1279105392156863) 100%\n    );\n    height: 1px;\n  }\n}\n";

const _tmpl$$4 = /*#__PURE__*/web.template(`<div class="wallets-list-main-wrapper"><div class="wallets-list-wrapper"></div><button class="wallets-button">Pair wallet on another device</button></div>`, 6);
const Wallets = props => {
  return (() => {
...
var styles$3 = ".info-wrapper {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  gap: 0.5em;\n  border-radius: 10px;\n  padding: 30px;\n}\n\n.info-border {\n  border: 1px solid #aaaaaa42;\n}\n\n.info-icon {\n  width: 40px;\n  height: 40px;\n  border-radius: 6px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  font-size: 28px;\n  margin-bottom: 0.2em;\n}\n\n.info-badge {\n  background-color: #3880ff;\n  font-size: 38px;\n  -webkit-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  -moz-box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n  box-shadow: 0px 0px 12px -4px rgb(0 0 0 / 30%);\n}\n\n.theme__dark .info-title {\n  color: white;\n}\n\n.theme__dark .info-description {\n  color: #aeaeae;\n}\n\n.info-title {\n  text-align: center;\n  color: #334155;\n  margin: 0px;\n  font-size: 1em;\n}\n\n.info-description {\n  text-align: center;\n  font-size: 0.8em;\n  font-weight: 300;\n  color: #7c828b;\n  line-height: 1.25em;\n  margin: 6px 0px 12px 0px;\n  margin: 0px;\n  max-width: 300px;\n}\n\n.info-data {\n  font-size: 0.8em;\n  font-weight: 300;\n  color: #7c828b;\n  line-height: 1.25em;\n  margin: 6px 0px 12px 0px;\n  margin: 0px;\n  overflow: scroll;\n  max-height: 300px;\n}\n\n.info-buttons {\n  display: flex;\n  align-items: center;\n  gap: 0.6em;\n}\n\n.info-button {\n  border-radius: 6px;\n  background-color: #3880ff;\n  border: 1px solid #3880ff;\n  color: white;\n  padding: 0.6em 1.2em;\n  width: 180px;\n  transition: all ease 0.2s;\n  cursor: pointer;\n  margin-top: 1em;\n  font-size: 0.8em;\n}\n\n.info-button:hover {\n  background-color: #166afc;\n}\n\n.info-button-secondary {\n  border-radius: 6px;\n  background-color: transparent;\n  border: 1px solid #3880ff;\n  color: #3880ff;\n  padding: 0.6em 1.2em;\n  width: 180px;\n  transition: all ease 0.2s;\n  cursor: pointer;\n  margin-top: 1em;\n}\n\n.info-button-secondary:hover {\n  background-color: #e8f0ff;\n}\n\n@media only screen and (max-width: 800px) {\n  .info-title {\n    font-size: 0.9em;\n    line-height: 1em;\n  }\n\n  .info-description {\n    font-size: 0.65em;\n  }\n\n  .qr-more-info {\n    font-size: 0.75em;\n  }\n\n  .info-wrapper {\n    max-height: 180px;\n    padding: 1.2em;\n  }\n\n  .info-icon {\n    width: 40px;\n    height: 40px;\n    font-size: 1.8em;\n  }\n\n  .info-button {\n    padding: 0.5em 1.6em;\n    font-size: 0.7em;\n  }\n}\n";

const _tmpl$$3 = /*#__PURE__*/web.template(`<div><h3 class="info-title"></h3><div class="info-buttons"></div></div>`, 6),
  _tmpl$2$3 = /*#__PURE__*/web.template(`<div></div>`, 2),
  _tmpl$3$3 = /*#__PURE__*/web.template(`<div class="info-description"></div>`, 2),
...
const Info = props => {
  return (() => {
    ...
    web.insert(_el$, (() => {
      ...
      return () => _c$() && (() => {
        const _el$4 = _tmpl$2$3.cloneNode(true);
...
var styles$2 = ".qr-wrapper {\n  display: flex;\n  align-items: flex-start;\n  justify-content: center;\n  gap: 0.5em;\n  border: 1px solid #aaaaaa42;\n  border-radius: 10px;\n  padding: 30px;\n  height: 200px;\n}\n\n.qr-left {\n  display: flex;\n  flex-direction: column;\n  max-width: 16em;\n  height: 100%;\n}\n\n.qr-left h3 {\n  color: #334155;\n  margin: 0px;\n  margin-bottom: 0.4em;\n  font-size: 1em;\n}\n\n.theme__dark .qr-left h3 {\n  color: white;\n}\n\n.theme__dark .qr-left span {\n  color: #aeaeae;\n}\n\n.theme__dark .qr-copy-wrapper p {\n  color: #aeaeae;\n}\n\n.qr-left span {\n  font-size: 0.8em;\n  font-weight: 300;\n  color: #7c828b;\n  line-height: 1.35em;\n  margin: 0px;\n}\n\n.qr-more-info {\n  font-size: 0.95em !important;\n  text-decoration: underline;\n  margin-left: 6px !important;\n  cursor: pointer;\n}\n\n.qr-right {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  height: 100%;\n  border-radius: 6px;\n  transition: all ease 0.2s;\n  cursor: pointer;\n}\n\n.theme__dark .qr-right:hover {\n  background-color: rgba(238, 238, 238, 0.492);\n}\n\n.qr-right:hover {\n  background-color: rgb(238, 238, 238);\n}\n\n.qr-copy-wrapper {\n  display: flex;\n  align-items: center;\n  gap: 0.6em;\n  color: #7c828b;\n  margin-bottom: 8px;\n  margin-top: 18px;\n}\n\n.qr-copy-wrapper svg {\n  font-size: 1em;\n}\n\n.qr-copy-wrapper p {\n  font-size: 0.8em;\n  margin: 0px;\n}\n\n.qr-svg-wrapper {\n  background-color: white;\n  border-radius: 10px;\n}\n\n.qr-svg-wrapper svg rect {\n  fill: transparent !important;\n}\n\n@media only screen and (max-width: 800px) {\n  .qr-wrapper {\n    flex-direction: column;\n    align-items: center;\n    justify-content: center;\n    height: 340px;\n  }\n\n  .qr-left {\n    margin: 0.6em 0px;\n  }\n\n  .qr-left h3 {\n    font-size: 1em;\n    line-height: 1em;\n  }\n\n  .qr-left p {\n    font-size: 0.75em;\n    text-align: center;\n  }\n\n  .qr-left > div {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n  }\n\n  .qr-more-info {\n    font-size: 0.75em;\n  }\n}\n";

const _tmpl$$2 = /*#__PURE__*/web.template(`<div class="qr-wrapper"><div class="qr-left"></div><div class="qr-right"></div></div>`, 6),
  _tmpl$2$2 = /*#__PURE__*/web.template(`<h3>Or scan to connect</h3>`, 2),
  _tmpl$3$2 = /*#__PURE__*/web.template(`<span></span>`, 2),
...
const QR = props => {
  ...
  return (() => {
    ...
    web.insert(_el$2, (() => {
      ...
      return () => _c$() && _tmpl$2$2.cloneNode(true);
    })(), null);
    web.insert(_el$2, (() => {
...
const _tmpl$$1 = /*#__PURE__*/web.template(`<div></div>`, 2),
  _tmpl$2$1 = /*#__PURE__*/web.template(`<div><div></div><div></div><div></div><div></div></div>`, 10),
...
const openAlert = config => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const wcpaylouad = (_b = config.pairingPayload) === null || _b === void 0 ? void 0 : _b.walletConnectSyncCode();
  ...
  wcpaylouad === null || wcpaylouad === void 0 ? void 0 : wcpaylouad.then(() => {
  ...
  if (!isOpen$1()) {
    const availableExtensions = yield beaconTransportPostmessage.PostMessageTransport.getAvailableExtensions();
    ...
    const wallets = [...desktopList.map(wallet => {
      return {
        id: wallet.key,
        key: wallet.key,
      ...
      var _a, _b;
      const link = wallet.links[(_b = (_a = config.pairingPayload) === null || _a === void 0 ? void 0 : _a.preferredNetwork) !== null && _b !== void 0 ? _b : beaconTypes.NetworkType.MAINNET];
      return {
        id: wallet.key,
        key: wallet.key,
        name: wallet.shortName,
    ...
    const arrangedWallets = arrangeTopWallets(mergedWallets, (_c = config.featuredWallets) !== null && _c !== void 0 ? _c : defaultWalletList);
    const isMobile = window.innerWidth <= 800;
    ...
    const handleClickWallet = id => __awaiter(void 0, void 0, void 0, function* () {
      ...
      if (wallet === null || wallet === void 0 ? void 0 : wallet.key) {
        (_d = analytics()) === null || _d === void 0 ? void 0 : _d.track('click', 'ui', 'opened wallet', {
          key: wallet.key
        });
      ...
      if (wallet && ((_e = wallet.supportedInteractionStandards) === null || _e === void 0 ? void 0 : _e.includes('wallet_connect'))) {
        const uri = (_f = yield wcpaylouad) === null || _f === void 0 ? void 0 : _f.uri;
        if (uri) {
    ...
    const handleClickOther = () => __awaiter(void 0, void 0, void 0, function* () {
      var _g;
      (_g = analytics()) === null || _g === void 0 ? void 0 : _g.track('click', 'ui', 'other wallet');
      setShowMoreContent(false);
      setCurrentWallet(Object.assign(Object.assign({}, arrangedWallets[0]), {
        name: '',
        types: ['ios']
      }));
      // TODO: replace with storage class
      localStorage.setItem(beaconTypes.StorageKey.LAST_SELECTED_WALLET, arrangedWallets[0].key);
      setDefaultPayload();
      setCurrentInfo('install');
    });
    const handleClickConnectExtension = () => __awaiter(void 0, void 0, void 0, function* () {
      var _h, _j, _k, _l, _m, _o;
      (_h = analytics()) === null || _h === void 0 ? void 0 : _h.track('click', 'ui', 'open extension', {
        key: (_j = currentWallet()) === null || _j === void 0 ? void 0 : _j.key
      });
      setShowMoreContent(false);
      if ((_k = config.pairingPayload) === null || _k === void 0 ? void 0 : _k.postmessageSyncCode) {
        const serializer = new beaconCore.Serializer();
        ...
        const message = {
          ...
          targetId: (_l = currentWallet()) === null || _l === void 0 ? void 0 : _l.id
        };
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        beaconCore.windowRef.postMessage(message, beaconCore.windowRef.location.origin);
        if ((_m = currentWallet()) === null || _m === void 0 ? void 0 : _m.firefoxId) {
          const message = {
            target: beaconTypes.ExtensionMessageTarget.EXTENSION,
            payload: postmessageCode,
            targetId: (_o = currentWallet()) === null || _o === void 0 ? void 0 : _o.firefoxId
          };
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
          beaconCore.windowRef.postMessage(message, beaconCore.windowRef.location.origin);
        }
    ...
    const handleClickInstallExtension = () => __awaiter(void 0, void 0, void 0, function* () {
      var _p, _q, _r;
      (_p = analytics()) === null || _p === void 0 ? void 0 : _p.track('click', 'ui', 'install extension', {
        key: (_q = currentWallet()) === null || _q === void 0 ? void 0 : _q.key
      });
      setShowMoreContent(false);
      window.open(((_r = currentWallet()) === null || _r === void 0 ? void 0 : _r.link) || '', '_blank', 'noopener');
    });
    const handleClickOpenDesktopApp = () => __awaiter(void 0, void 0, void 0, function* () {
      var _s, _t, _u, _v, _w;
      setShowMoreContent(false);
      (_s = analytics()) === null || _s === void 0 ? void 0 : _s.track('click', 'ui', 'open desktop', {
        key: (_t = currentWallet()) === null || _t === void 0 ? void 0 : _t.key
      });
      if ((_u = config.pairingPayload) === null || _u === void 0 ? void 0 : _u.p2pSyncCode) {
        const serializer = new beaconCore.Serializer();
        const code = yield serializer.serialize(yield (_v = config.pairingPayload) === null || _v === void 0 ? void 0 : _v.p2pSyncCode());
        const link = getTzip10Link(((_w = currentWallet()) === null || _w === void 0 ? void 0 : _w.deepLink) || '', code);
        window.open(link, '_blank', 'noopener');
      }
    });
    const handleClickDownloadDesktopApp = () => __awaiter(void 0, void 0, void 0, function* () {
      var _x, _y, _z;
      (_x = analytics()) === null || _x === void 0 ? void 0 : _x.track('click', 'ui', 'download desktop', {
        key: (_y = currentWallet()) === null || _y === void 0 ? void 0 : _y.key
      });
      setShowMoreContent(false);
      window.open(((_z = currentWallet()) === null || _z === void 0 ? void 0 : _z.link) || '', '_blank', 'noopener');
    });
    const hasExtension = () => {
      var _a, _b;
          ...
          return () => _c$() && web.createComponent(Alert, {
            ...
            get content() {
              return (() => {
                ...
                web.insert(_el$3, (() => {
                  const _c$3 = web.memo(() => !!(!isMobile && ((_a = currentWallet()) === null || _a === void 0 ? void 0 : _a.types.includes('extension'))));
                  return () => _c$3() && web.createComponent(Info, {
                    border: true,
                    get title() {
                ...
                web.insert(_el$3, (() => {
                  const _c$4 = web.memo(() => !!(!isMobile && ((_e = currentWallet()) === null || _e === void 0 ? void 0 : _e.types.includes('desktop'))));
                  return () => _c$4() && web.createComponent(Info, {
                    border: true,
                ...
                web.insert(_el$3, (() => {
                  const _c$5 = web.memo(() => !!(!isMobile && codeQR().length > 0 && ((_f = currentWallet()) === null || _f === void 0 ? void 0 : _f.types.includes('ios')) && ((_g = currentWallet()) === null || _g === void 0 ? void 0 : _g.types.length) > 1));
                  return () => _c$5() && web.createComponent(QR, {
                    get isWalletConnect() {
                ...
                web.insert(_el$3, (() => {
                  const _c$6 = web.memo(() => !!(!isMobile && codeQR().length > 0 && ((_l = currentWallet()) === null || _l === void 0 ? void 0 : _l.types.includes('ios')) && ((_m = currentWallet()) === null || _m === void 0 ? void 0 : _m.types.length) <= 1));
                  return () => _c$6() && web.createComponent(QR, {
                    get isWalletConnect() {
                ...
                web.insert(_el$3, (() => {
                  const _c$7 = web.memo(() => !!(isMobile && codeQR().length > 0));
                ...
                web.insert(_el$4, web.createComponent(Wallets, {
                  get disabled() {
                    return isLoading();
                  },
                  get wallets() {
                    return arrangedWallets.slice(-(arrangedWallets.length - (isMobile ? 3 : 4)));
                  },
                  onClickWallet: handleClickWallet,
                  onClickOther: handleClickOther
                }));
                web.insert(_el$5, web.createComponent(Info, {
                  iconBadge: true,
                  get icon() {
                ...
                web.insert(_el$6, web.createComponent(TopWallets, {
                  get disabled() {
                    return isLoading();
                  },
                  get wallets() {
                    return isMobile ? arrangedWallets.slice(0, 3) : arrangedWallets.slice(0, 4);
                  },
                  onClickWallet: handleClickWallet,
                  onClickLearnMore: handleClickLearnMore,
                  get otherWallets() {
                ...
                web.effect(_p$ => {
                  const _v$ = currentInfo() === 'install' ? {
                    ...
                    _v$4 = currentInfo() !== 'install' && currentInfo() !== 'wallets' && currentInfo() !== 'help' ? {
                      opacity: 1,
                      height: 'unset',
                      overflow: 'unset',
                      transform: 'scale(1)',
                  ...
                  _p$._v$4 = web.style(_el$6, _v$4, _p$._v$4);
                  return _p$;
                }, {
                  _v$: undefined,
                  _v$2: undefined,
            ...
            get extraContent() {
              return web.memo(() => !!(currentInfo() !== 'top-wallets' || isMobile))() ? undefined : web.createComponent(Wallets, {
                ...
                small: true,
                get wallets() {
                  return arrangedWallets.slice(-(arrangedWallets.length - 4));
                },
                onClickWallet: handleClickWallet,
                onClickOther: handleClickOther
              });
            ...
            get onBackClick() {
              return web.memo(() => !!(currentInfo() === 'install' && !isMobile))() ? () => setCurrentInfo('top-wallets') : web.memo(() => !!(currentInfo() === 'install' && isMobile))() ? () => setCurrentInfo('wallets') : web.memo(() => !!(currentInfo() === 'wallets' && isMobile))() ? () => setCurrentInfo('top-wallets') : currentInfo() === 'help' ? () => setCurrentInfo(previousInfo()) : undefined;
            }
          });
        })(), null);
        web.insert(_el$, (() => {
...
const _tmpl$ = /*#__PURE__*/web.template(`<img>`, 1),
  ...
  _tmpl$6 = /*#__PURE__*/web.template(`<div class="toast-body"></div>`, 2),
  _tmpl$7 = /*#__PURE__*/web.template(`<div class="toast-action-wrapper"><p></p></div>`, 4),
  _tmpl$8 = /*#__PURE__*/web.template(`<div class="toast-action-button"></div>`, 2);
...
const Toast = props => {
  ...
  return (() => {
    ...
    web.insert(_el$4, (() => {
      const _c$2 = web.memo(() => !!props.actions);
      return () => _c$2() && (() => {
        ...
        web.insert(_el$8, web.createComponent(solidJs.For, {
          ...
          children: action => (() => {
            const _el$9 = _tmpl$7.cloneNode(true),
              _el$10 = _el$9.firstChild;
            web.insert(_el$10, () => action.text);
            web.insert(_el$9, (() => {
              const _c$3 = web.memo(() => !!action.actionText);
              return () => _c$3() && (() => {
                const _el$11 = _tmpl$8.cloneNode(true);
                _el$11.$$click = () => {
                  if (action.actionCallback) action.actionCallback();
                };
                web.insert(_el$11, () => action.actionText);
                return _el$11;
              })();
            })(), null);
            web.effect(() => web.className(_el$10, `toast-action-label ${action.isBold ? 'toast-action-bold' : ''}`));
            return _el$9;
          })()
        }));
        return _el$8;
