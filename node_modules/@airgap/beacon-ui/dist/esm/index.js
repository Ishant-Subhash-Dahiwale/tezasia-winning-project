...
const _tmpl$$8 = /*#__PURE__*/template(`<div class="loader"></div>`, 2);
const Loader = _ => {
  return _tmpl$$8.cloneNode(true);
};

const _tmpl$$7 = /*#__PURE__*/template(`<div><div><div class="alert-header"><div class="alert-logo"></div><div class="alert-button-icon"></div></div><div class="alert-modal-loading-wrapper"></div><div class="alert-body"></div></div></div>`, 14),
  _tmpl$2$6 = /*#__PURE__*/template(`<div class="alert-button-icon"></div>`, 2),
  _tmpl$3$5 = /*#__PURE__*/template(`<div class="alert-button-icon-empty"></div>`, 2),
...
const _tmpl$$6 = /*#__PURE__*/template(`<div></div>`, 2),
  _tmpl$2$5 = /*#__PURE__*/template(`<div><div><h3></h3></div><div class="wallet-main-right"><img></div></div>`, 9),
  _tmpl$3$4 = /*#__PURE__*/template(`<p></p>`, 2),
...
const _tmpl$$5 = /*#__PURE__*/template(`<div class="top-wallets-wrapper"><div class="top-wallets-info"><h3>Connect Wallet</h3><span>If you don't have a wallet, you can select a provider and create one now. <span class="top-wallets-learn-more">Learn more</span></span></div><div class="top-wallets-wallets-main"></div></div>`, 12),
  _tmpl$2$4 = /*#__PURE__*/template(`<div class="top-wallets-other-wallets"><div class="top-wallets-other-wallets-left"><h3>Other Wallets</h3><p>See other wallets you can use to connect</p></div><div class="top-wallets-other-wallets-right"><img><img class="top-wallets-other-wallets-center-wallet"><img></div></div>`, 13);
...
const _tmpl$$4 = /*#__PURE__*/template(`<div class="wallets-list-main-wrapper"><div class="wallets-list-wrapper"></div><button class="wallets-button">Pair wallet on another device</button></div>`, 6);
const Wallets = props => {
  return (() => {
...
const _tmpl$$3 = /*#__PURE__*/template(`<div><h3 class="info-title"></h3><div class="info-buttons"></div></div>`, 6),
  _tmpl$2$3 = /*#__PURE__*/template(`<div></div>`, 2),
  _tmpl$3$3 = /*#__PURE__*/template(`<div class="info-description"></div>`, 2),
...
const _tmpl$$2 = /*#__PURE__*/template(`<div class="qr-wrapper"><div class="qr-left"></div><div class="qr-right"></div></div>`, 6),
  _tmpl$2$2 = /*#__PURE__*/template(`<h3>Or scan to connect</h3>`, 2),
  _tmpl$3$2 = /*#__PURE__*/template(`<span></span>`, 2),
...
const _tmpl$$1 = /*#__PURE__*/template(`<div></div>`, 2),
  _tmpl$2$1 = /*#__PURE__*/template(`<div><div></div><div></div><div></div><div></div></div>`, 10),
...
const openAlert = config => __awaiter(void 0, void 0, void 0, function* () {
  ...
  if (!isOpen$1()) {
    ...
    const wallets = [...desktopList.map(wallet => {
      ...
      var _a, _b;
      const link = wallet.links[(_b = (_a = config.pairingPayload) === null || _a === void 0 ? void 0 : _a.preferredNetwork) !== null && _b !== void 0 ? _b : NetworkType.MAINNET];
      return {
        id: wallet.key,
        key: wallet.key,
        name: wallet.shortName,
          ...
          return () => _c$() && createComponent(Alert, {
            ...
            get content() {
              return (() => {
                ...
                insert(_el$3, (() => {
                  const _c$3 = memo(() => !!(!isMobile && ((_a = currentWallet()) === null || _a === void 0 ? void 0 : _a.types.includes('extension'))));
                  return () => _c$3() && createComponent(Info, {
                    border: true,
                    get title() {
                ...
                insert(_el$3, (() => {
                  const _c$4 = memo(() => !!(!isMobile && ((_e = currentWallet()) === null || _e === void 0 ? void 0 : _e.types.includes('desktop'))));
                  return () => _c$4() && createComponent(Info, {
                    border: true,
                ...
                insert(_el$3, (() => {
                  const _c$5 = memo(() => !!(!isMobile && codeQR().length > 0 && ((_f = currentWallet()) === null || _f === void 0 ? void 0 : _f.types.includes('ios')) && ((_g = currentWallet()) === null || _g === void 0 ? void 0 : _g.types.length) > 1));
                  return () => _c$5() && createComponent(QR, {
                    get isWalletConnect() {
                ...
                insert(_el$3, (() => {
                  const _c$6 = memo(() => !!(!isMobile && codeQR().length > 0 && ((_l = currentWallet()) === null || _l === void 0 ? void 0 : _l.types.includes('ios')) && ((_m = currentWallet()) === null || _m === void 0 ? void 0 : _m.types.length) <= 1));
                  return () => _c$6() && createComponent(QR, {
                    get isWalletConnect() {
                ...
                insert(_el$3, (() => {
                  const _c$7 = memo(() => !!(isMobile && codeQR().length > 0));
                ...
                insert(_el$4, createComponent(Wallets, {
                  get disabled() {
                    return isLoading();
                  },
                  get wallets() {
                ...
                insert(_el$5, createComponent(Info, {
                  iconBadge: true,
                  get icon() {
                ...
                insert(_el$6, createComponent(TopWallets, {
                  get disabled() {
                    return isLoading();
                  },
                  get wallets() {
                ...
                effect(_p$ => {
                  ...
                  _p$._v$4 = style(_el$6, _v$4, _p$._v$4);
                  return _p$;
                }, {
                  _v$: undefined,
                  _v$2: undefined,
            ...
            get onBackClick() {
              return memo(() => !!(currentInfo() === 'install' && !isMobile))() ? () => setCurrentInfo('top-wallets') : memo(() => !!(currentInfo() === 'install' && isMobile))() ? () => setCurrentInfo('wallets') : memo(() => !!(currentInfo() === 'wallets' && isMobile))() ? () => setCurrentInfo('top-wallets') : currentInfo() === 'help' ? () => setCurrentInfo(previousInfo()) : undefined;
            }
          });
        })(), null);
        insert(_el$, (() => {
...
const _tmpl$ = /*#__PURE__*/template(`<img>`, 1),
  ...
  _tmpl$6 = /*#__PURE__*/template(`<div class="toast-body"></div>`, 2),
  _tmpl$7 = /*#__PURE__*/template(`<div class="toast-action-wrapper"><p></p></div>`, 4),
  _tmpl$8 = /*#__PURE__*/template(`<div class="toast-action-button"></div>`, 2);
        ...
        insert(_el$8, createComponent(For, {
          ...
          children: action => (() => {
            const _el$9 = _tmpl$7.cloneNode(true),
              _el$10 = _el$9.firstChild;
            insert(_el$10, () => action.text);
            insert(_el$9, (() => {
              const _c$3 = memo(() => !!action.actionText);
              return () => _c$3() && (() => {
                const _el$11 = _tmpl$8.cloneNode(true);
                _el$11.$$click = () => {
                  if (action.actionCallback) action.actionCallback();
                };
                insert(_el$11, () => action.actionText);
                return _el$11;
              })();
            })(), null);
            effect(() => className(_el$10, `toast-action-label ${action.isBold ? 'toast-action-bold' : ''}`));
            return _el$9;
          })()
        }));
        return _el$8;
